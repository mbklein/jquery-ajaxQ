...
f.ajax;f.ajax=function(c){if(c.ajaxQ){var b=c.ajaxQ;if(e.hasOwnProperty(b)){var d=f.Deferred(),a=d.promise();a.success=a.done;a.error=a.fail;a.complete=a.always;a.abort=function(){h(queueName,d)};delete c.ajaxQ;i(b,c,d);return a}else throw"QueueError: queue '"+options.queue+"' is not defined.";}else return j(c)}})(jQuery);
